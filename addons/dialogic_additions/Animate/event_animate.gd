...
func _execute() -> void:
	...
	CutsceneManager.animate(character_path, animation_name, is_loop)
...
func build_event_editor() -> void:
	add_header_edit('character_path', ValueType.SINGLELINE_TEXT, {'left_text':'Animate the character at path'})
