...
func change_level(level_path: String, spawn_id := "") -> void:
	level_load_started.emit()
	await _do_level_swap(level_path, spawn_id)
	level_load_finished.emit()

func change_level_with_transition(level_path: String, transition_path: String, spawn_id := "") -> void:
...
func _do_level_swap(level_path: String, spawn_id: String) -> void:
